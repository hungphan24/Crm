                                    ...
                                    <c:if test = "${item.getStatus().equals('Chưa thực hiện')}">
                                        <a href="#">
                                           <div class="mail-contnet">
                                               ...
                                               <span class="time">Bắt đầu: ${item.getStart()}</span>
                                               <span class="time">Kết thúc: ${item.getEnd()}</span>
                                           </div>
                                        </a>
                                    </c:if>
                                     ...
                                     <c:if test = "${item.getStatus().equals('Đang thực hiện')}">
                                         <a href="#">
                                              <div class="mail-contnet">
                                                  <h5>${item.getName()}</h5>
                                                      <span class="mail-desc"></span>
                                                       <span class="time">Bắt đầu: ${getStart()}</span>
                                                       <span class="time">Kết thúc: ${getEnd()}</span>
                                              </div>
                                         </a>
                                     </c:if>
